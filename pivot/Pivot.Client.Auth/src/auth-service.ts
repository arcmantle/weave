import type { LoginRequest, LoginResponse, LoginResult, UserInfo } from './models/auth.js';

export class AuthenticationService {

	protected currentUser:    string | null = null;
	protected hasFetched:     boolean = false;
	...
	protected async performRefresh(): Promise<boolean> {
		try {
