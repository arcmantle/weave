import { DEV_MODE, HTML_RESULT, issueWarning, MATHML_RESULT, type ResultType, SVG_RESULT } from './constants.ts';
import type { TemplateProducer, TemplateResult } from './parts/types.ts';
 ...
 */
export const tag = <T extends ResultType>(
	type: T,
) => (
