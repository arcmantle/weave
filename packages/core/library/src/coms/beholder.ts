...
class Beholder {
	...
	static dispatch(phenom: Phenomenon): void {
...
export const addBeholder: typeof Beholder.add = Beholder.add;
export const removeBeholder: typeof Beholder.remove = Beholder.remove;
export const dispatchPhenom: typeof Beholder.dispatch = Beholder.dispatch;
