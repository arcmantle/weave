...
const optionsCache: WeakMap<object, ObserveOptions> = new WeakMap();
...
export const getOptions = (root: object): ObserveOptions => optionsCache.get(root) ?? {};
export const setOptions = (root: object, options: ObserveOptions): void => { optionsCache.set(root, options); };
