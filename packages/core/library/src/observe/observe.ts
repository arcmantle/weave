...
const core = createObserveCore({ getBatchFrames: r => batchApi.getBatchFrames(r) });
const observe = core.observe as Observe;
...
observe.beginBatch = (obj) => batchApi.beginBatch(core.getRoot(obj));
observe.commitBatch = (obj) => batchApi.commitBatch(core.getRoot(obj));
observe.rollbackBatch = (obj) => batchApi.rollbackBatch(core.getRoot(obj));
