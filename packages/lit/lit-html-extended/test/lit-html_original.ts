...
//				// in asyncCheckDiv.
//				const asyncCheckDivRendered: Promise<void> = new Promise((res, rej) => {
//					resolve = res;
//					reject = rej;
//				});
...
//				render(log: string[], id = '', value?: unknown, bool = true) {
//					this.log = log;
//					this.id = id;
...
//			assert.deepEqual(sanitizerCalls, [ { values: [ 'bad', safe ], name: 'foo', type: 'property', nodeName: 'DIV' } ]);
//		});
//	});
