...
type ShadyWindow = typeof window & {
	ShadyDOM?: {
		inUse:   boolean;
		noPatch: boolean;
		wrap:    (node: Node) => Node;
...
): value is UncompiledTemplateResult => type === undefined
...
export const isCompiledTemplateResult = (
	value: unknown,
	// This property needs to remain unminified.
): value is CompiledTemplateResult => (value as CompiledTemplateResult)?.['_$litType$']?.h != null;
...
export const isDirectiveResult = (
	value: unknown,
	// This property needs to remain unminified.
): value is DirectiveResult => (value as DirectiveResult)?.['_$litDirective$'] !== undefined;


/**
 * Retrieves the Directive class for a DirectiveResult
 */
export const getDirectiveClass = (
	value: unknown,
	// This property needs to remain unminified.
...
const RESET_VALUE = Object.freeze({});
...
export const setCommittedValue = (
	part: Part, value: unknown = RESET_VALUE,
): unknown => (part._$committedValue = value);
 ...
 * @param part
 */
export const getCommittedValue = (part: ChildPart): unknown => part._$committedValue;
