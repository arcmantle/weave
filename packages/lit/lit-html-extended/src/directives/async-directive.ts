...
import type { AttributePart, ChildPart } from '../internal.ts';
import type { Disconnectable } from '../parts/disconnectable.ts';
import type { Part } from '../parts/template.ts';
import { Directive, type PartInfo, PartType } from './directive.ts';
   ...
   */
	setValue(value: unknown): void {
		if (isSingleExpression(this.__part as unknown as PartInfo)) {
			...
			const newValues = [ ...(this.__part._$committedValue as unknown[]) ];
