...
const stringsCache: Map<string, TemplateStringsArray> = new Map();
...
export const withStatic = (
	...
	if (hasStatics) {
		...
		if (strings === undefined) {
			...
			(staticStrings as string[] & { raw: string[]; }).raw = staticStrings;
 ...
 */
export const html: TemplateProducer = withStatic(coreHtml);
 ...
 * Includes static value support from `lit-html/static.js`.
 */
export const svg: TemplateProducer = withStatic(coreSvg);
 ...
 * Includes static value support from `lit-html/static.js`.
 */
export const mathml: TemplateProducer = withStatic(coreMathml);
